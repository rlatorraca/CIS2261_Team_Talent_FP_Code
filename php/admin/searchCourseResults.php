 ...
 * 2/14/2019
 *
 * Page to display the search results of the students registered in a course which was pre-selected in the searchCourse.php page.
 *
 ...
 * assignCourse.php, searchCourses.php.
 *
 */
...
<head>
    ...
    <title>STARS - Search Course Results</title>
        ...
        <table class="table table-striped">
            ...
            while ($row = $resultCourseSearch->fetch_assoc()) {
                ...
                <tr>
                    ...
                    echo "<td><a class='delete' href='deleteEnrollment.php?studentID=" . $studentID . "&classID=" . $classID . "'>Delete</a></td>";
                    ?>
                </tr>
                <?php
            }
            ...
            // if no results display message to advise user
                ...
                echo "<div class='container'><div class='alert alert-danger'>Sorry there are no results for your search.</div></div>";
            }
            //Reset link
