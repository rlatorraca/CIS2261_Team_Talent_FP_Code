 ...
 * Date: 2/14/2019
 *
 * Page which allows admin users the ability to add students to the STARS database.
 * Page requires that a user in the system with the student access code of '5' be chosen when adding a new user.
 *
 * Required pages: stars.css, login.php, checkLogin.php, authenticateAdminPages.php, dbConn.php, addUser.php.
 */
        ...
        <div class="container container-larger" id="addStudent">
            ...
            <form action="confirmStudent.php" method="post">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        //Confirmation button to send data to the confirmStudent.php page to further the process.
                        $confirm = new Button();
