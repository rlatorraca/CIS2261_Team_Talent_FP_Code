...
if (isset($_GET["add"])) {
    ...
    if ($_GET["userID"] == "" || $_GET["username"] == "" || $_GET["password"] == "" || $_GET["accessCode"] == "") {
        ...
        echo "<form action='add_User.php' method='post'><fieldset><div class='col-md-12'><button id='customBtn'>Try Again</button></div></fieldset></form>";
    ...
    if ($result) {
        ...
        echo "<form action='add_User.php' method='post'><fieldset><div class='col-md-12'>Add Another User</button></div></fieldset></form>";
