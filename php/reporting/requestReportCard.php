<?php
     ...
     * Date: 2/14/2019
     *
     * This is the page used when user request to view a report card.
     *
     * This page requires: stars.css, index.php, login.php, checkLoggedIn.php, dbConn.php, displayReportCard.php .
     *
     */
    ...
    <body>
        ...
        <div class="jumbotron-fluid">
            <div class="container-fluid login">
                <!--Form to request to view a student's report card.-->
