...
<body>
    ...
    <?php
        ...
        //SQL query to pull all enrollment data for a student (Be sure to again use the studentID pulled from the request page)
        $query2 = "SELECT enrollment.enrollmentID, course.courseName, subject.subjectCode, mark, attendance, 
                    ...
                    FROM student, enrollment, course, courseoffering, subject, educator 
            ...
            while ($row = $result2->fetch_assoc()){
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <?php echo $row["educator.firstName"]." ".$row["educator.lastName"]; ?></td>
                    </tr>
                </tbody>
                <?php } ?>
                </table>
